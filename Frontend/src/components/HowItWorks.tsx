    ...
    <section id="how-it-works" className="py-20 sm:py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12 space-y-2">
          <span className="inline-block text-xs font-bold uppercase tracking-wider text-emerald-800 bg-emerald-50 px-3.5 py-1 rounded-full border border-emerald-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          {TIMELINE_STEPS.map((step, index) => (
            <motion.div
              ...
              className="bg-white p-6 rounded-2xl border border-gray-200 hover:border-emerald-600 shadow-xs hover:shadow-lg transition-all flex flex-col justify-between relative group"
            >
              <div className="space-y-4">
                {/* Step badge & number */}
                <div className="flex items-center justify-between">
                  <div className="w-10 h-10 rounded-xl bg-gray-100 border border-gray-200 flex items-center justify-center group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                ...
                <div className="space-y-1.5">
                  <h3 className="font-manrope text-lg font-bold text-gray-900 group-hover:text-emerald-700 transition-colors uppercase tracking-tight">
                    {step.title}
                  </h3>
              ...
              <div className="pt-4 mt-4 border-t border-gray-100 flex items-center justify-between font-inter text-xs">
                ...
                <span className="font-bold text-emerald-800 bg-emerald-50/80 px-2 py-0.5 rounded border border-emerald-100 text-[11px]">
                  {step.keyDeliverable}
                </span>
              </div>
            </motion.div>
        ...
        <div className="mt-16 bg-gray-900 text-white rounded-2xl p-8 sm:p-10 shadow-lg flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 shrink-0">
            <button
              ...
              className="px-6 py-3 text-xs font-bold text-emerald-950 bg-emerald-400 hover:bg-emerald-300 rounded-xl transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
            >
