  ...
  return (
    <section className="py-12 sm:py-16 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main CTA Card */}
        <div className="relative glass-card-dark text-white rounded-2xl p-6 sm:p-10 lg:p-12 border border-blue-500/30 shadow-soft-lg overflow-hidden text-center max-w-4xl mx-auto">
          ...
          <div className="relative z-10 space-y-4 max-w-2xl mx-auto">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-500/20 border border-blue-500/30 text-blue-300 text-xs font-semibold uppercase tracking-wider">
            ...
            <h2 className="font-manrope text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-white leading-tight">
              Ready to Validate Your <span className="text-blue-400">Greenfield Project</span>?
            </h2>
            ...
            <div className="pt-4 border-t border-slate-800/80 flex flex-wrap items-center justify-center gap-4 text-xs text-gray-400 font-medium">
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-blue-400" /> No credit card required
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5 text-blue-400" /> 100% Confidential NDA
              </span>
              <span className="flex items-center gap-1.5">
                <ShieldCheck className="w-3.5 h-3.5 text-blue-400" /> Instant Feasibility Check Report
              </span>
            </div>
