export const DEFAULT_INDUSTRIES = [
  ...
  {
    slug: 'solar-power',
    name: 'Solar Power Plant (Ground-Mounted & Rooftop)',
    category: 'Renewable Energy & Clean-Tech',
    iconName: 'Sun',
    description: 'Grid-connected solar PV projects with PPA off-take, net metering, and accelerated depreciation.',
    avgLoanSize: '₹1 Cr - ₹150 Cr',
    feasibilityRate: '94%',
    keyFactors: ['PPA Off-take Security (DISCOM/Commercial)', 'Solar Radiation (GHI) Assessment', 'Grid Substation Evacuation Clearance'],
    popularRegions: ['Gujarat', 'Rajasthan', 'Telangana', 'Karnataka', 'Maharashtra'],
    overview: 'Solar energy projects represent secure, bankable infrastructure investments backed by long-term 25-year Power Purchase Agreements (PPAs) and favorable central/state subsidies.',
    projectCostRange: 'Small Rooftop: ₹1–5 Cr | Medium (5-10 MW): ₹20–45 Cr | Large Utility: ₹50–150 Cr+',
    fundingStructure: 'Promoter Equity: 25% – 30% | Term Loan / Debt: 70% – 75%',
    dscrNorms: 'DSCR ≥ 1.25–1.40 | Repayment: 10 – 15 years',
    roiAndPayback: 'EBITDA Margins: 75% – 85% | Payback Period: 4 – 6 years (Project IRR: 14-18%)',
    subsidiesAndSchemes: [
      'PM Surya Ghar / PM-KUSUM Component A & C Subsidies',
      'Accelerated Depreciation (40% under Income Tax Sec 32)',
      'IREDA & REC Concessional Green Financing Lines'
    ],
    eligibleBanks: ['State Bank of India', 'IREDA', 'PFC', 'REC', 'Punjab National Bank', 'HDFC Bank'],
    keyRisks: ['DISCOM payment delay', 'Solar panel import tariff changes', 'Grid curtailment risks']
  },
  {
    slug: 'rice-mill',
  ...
  },
  {
    ...
    subsidiesAndSchemes: [
      'RBI Priority Sector Lending (PSL) Status for Healthcare',
      'State Industrial Policy Capital Investment Subsidies',
      'NABH Hospital Credit Support Scheme'
    ],
    eligibleBanks: ['State Bank of India', 'Canara Bank', 'Bank of Baroda', 'HDFC Bank', 'ICICI Bank'],
    keyRisks: ['High initial equipment capex amortization', 'Doctor retention and staff attrition', 'Slow ramp up in bed occupancy']
  },
  {
    slug: 'resort-hotel',
    name: 'Resort & Eco-Tourism Hospitality',
    category: 'Hospitality & Real Estate',
    iconName: 'Hotel',
    description: 'Boutique eco-resorts, villas, banquets, and wellness tourism destinations with dining & spa facilities.',
    avgLoanSize: '₹5 Cr - ₹60 Cr',
    feasibilityRate: '88%',
    keyFactors: ['Scenic Tourism Connectivity', 'Local Panchayati / Town Planning Approvals', 'F&B + Banquet Revenue Share'],
    popularRegions: ['Goa', 'Kerala', 'Himachal Pradesh', 'Udaipur', 'Coorg'],
    overview: 'Eco-resorts and wellness retreats offer luxury accommodation, event spaces, and nature retreats, supported by domestic leisure travel growth and tourism subsidies.',
    projectCostRange: 'Small (15-25 keys): ₹5–15 Cr | Medium (40-80 keys): ₹15–45 Cr | Luxury Retreat: ₹45–100 Cr+',
    fundingStructure: 'Promoter Equity: 30% – 40% | Bank Loan: 60% – 70%',
    dscrNorms: 'DSCR ≥ 1.35–1.60 | Repayment: 8 – 12 years (Moratorium: 12 – 18 months)',
    roiAndPayback: 'EBITDA Margins: 25% – 40% | Payback Period: 5 – 8 years',
    subsidiesAndSchemes: [
...
export const DEFAULT_SERVICES = [
  ...
  },
  {
    ...
    deliverables: [
      ...
      'Market Sizing & Demand-Supply Analysis'
    ],
  ...
  {
    slug: 'cma-data-financial-modeling',
    name: 'CMA Data & Financial Modeling',
    tag: 'CA-Audited Projections',
    shortDesc: 'Multi-year CMA preparation including Balance Sheets, P&L, DSCR, IRR, Break-even & Sensitivity analysis.',
    fullDesc: 'Multi-year CMA preparation including Balance Sheets, P&L, DSCR, IRR, Break-even & Sensitivity analysis.',
    deliverables: [
      '5–10 Year CMA Financial Statements',
      'DSCR, ISCR & Break-Even Analysis',
      'Project IRR & Payback Financial Models'
    ],
    iconName: 'BarChart3',
  ...
  {
    slug: 'bank-loan-syndication',
    name: 'Bank Loan Syndication & Sanction Support',
    tag: 'Debt Syndication',
    shortDesc: 'End-to-end liaison with Nationalized Banks, NBFCs, and Private Lenders from file submission to loan sanction.',
    fullDesc: 'End-to-end liaison with Nationalized Banks, NBFCs, and Private Lenders from file submission to loan sanction.',
    deliverables: [
      'Credit Appraisal & Banker Presentation Deck',
      'Query Resolution with Credit Officers',
      'Sanction Letter & Disbursement Follow-up'
    ],
    iconName: 'Landmark',
    turnaroundTime: 'Ongoing',
    imageUrl: 'https://images.unsplash.com/photo-1541354329998-f4d9a9f9297f?w=800&auto=format&fit=crop&q=80',
    active: true
  },
  {
    slug: 'government-subsidies',
    name: 'Government Subsidy & Incentive Advisory',
    tag: 'Up to 35% Capital Subsidy',
    shortDesc: 'Identification and application filing for Central & State Industrial Subsidies, PMKSY, PLI, AIF, and PMEGP.',
    fullDesc: 'Identification and application filing for Central & State Industrial Subsidies, PMKSY, PLI, AIF, and PMEGP.',
    deliverables: [
      'State & Central Scheme Matching Matrix',
      'Capital & Interest Subsidy Documentation',
      'Liaison with State DIC / MSME Depts'
    ],
    iconName: 'Award',
  ...
  {
    slug: 'tefr-techno-economic-viability',
    name: 'TEV Study & CA Feasibility Certification',
    tag: 'Chartered Engineer & CA Certified',
    shortDesc: 'Techno-Economic Viability (TEV) study certified by registered Chartered Engineers and Chartered Accountants.',
    fullDesc: 'Techno-Economic Viability (TEV) study certified by registered Chartered Engineers and Chartered Accountants.',
    deliverables: [
      'Chartered Engineer Technical Certification',
      'Chartered Accountant Financial Vetting',
      'Bank Credit Committee Ready Dossier'
    ],
